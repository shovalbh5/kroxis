...
const faqs = [
  {
    ...
    a: 'עדשות מקוטבות מסננות סנוור ואור מוחזר, מה שמשפר את הנראות בעבודה בחוץ, באתרי בנייה חשופים ובסביבות עם מים. עדשות רגילות (Clear) מתאימות לעבודה במקומות סגורים כמו מעבדות ומפעלים.',
  },
  {
  ...
  {
    q: 'מה התקנים שמשקפי KROXIS עומדים בהם?',
    a: 'כל המוצרים שלנו עומדים בתקן ANSI Z87.1+ האמריקאי לעמידות בפגיעות. בנוסף, חלק מהדגמים עומדים בתקני CE EN166 האירופי ו-MIL-PRF הצבאי.',
  },
  {
    q: 'כמה זמן לוקח המשלוח?',
    a: 'הזמנות רגילות מגיעות תוך 3-5 ימי עסקים. הזמנות מעל ₪500 נהנות ממשלוח חינם. להזמנות B2B גדולות – אספקה ישירה לאתר תוך 5-7 ימי עסקים.',
  },
  {
  ...
  {
    q: 'האם אפשר להזמין בכמויות לחברה או לצוות?',
    a: 'בהחלט! דרך הפורטל העסקי שלנו ניתן לקבל הנחות כמות של עד 25%. פנו אלינו דרך דף הסיטונאות ונציג B2B ייצור קשר תוך 24 שעות.',
  },
  {
    q: 'מה זה עדשות אנטי-פוג?',
    a: 'עדשות אנטי-פוג מצופות בציפוי מיוחד שמונע הצטברות אדים. מתאים במיוחד לעבודה עם מסכות, בסביבות לחות, או כשמתחלפים בין סביבות חמות וקרות.',
  },
];
