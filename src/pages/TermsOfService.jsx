      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <div className="prose prose-sm max-w-none space-y-6 text-muted-foreground">
          ...
          <section>
            ...
            <p>משקפי KROXIS הם משקפי שמש טקטיות מקצועיות. יש להשתמש בהם בהתאם להוראות היצרן. המוצר מיועד להגנה מפני שמש וסביבות שטח ואינו מחליף ציוד מגן אישי נוסף הנדרש על פי חוק.</p>
          </section>
          ...
          <section>
            ...
            <p>משקפי KROXIS עומדים בתקני עמידות בינלאומיים עם הגנת UV400 מלאה, אך אינם מהווים תחליף לציוד מגן אישי מלא. השימוש במוצר הוא באחריות המשתמש בלבד. KROXIS לא תישא באחריות לנזק שנגרם כתוצאה משימוש לא תקין במוצר.</p>
          </section>
