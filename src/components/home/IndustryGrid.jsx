          ...
          {industries.map((ind, i) => (
            ...
            >
              ...
              >
                ...
                <h3 className="font-heading text-base sm:text-lg uppercase tracking-wide group-hover:text-primary transition-colors mb-2 font-bold">
                  {ind.label}
                </h3>
                <p className="text-sm text-muted-foreground/80 hidden sm:block font-medium">{ind.desc}</p>
              </Link>
            </motion.div>
          ))}
        </div>
