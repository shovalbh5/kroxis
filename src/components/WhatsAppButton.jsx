      ...
      <AnimatePresence>
        {open && (
          ...
          >
            ...
            {/* Chat Body */}
            <div className="bg-[#e5ddd5] p-4 min-h-[200px]" dir="rtl">
              <div className="bg-white rounded-lg rounded-tr-none p-3 shadow-sm max-w-[85%] mr-auto">
                ...
                <p className="text-[10px] text-gray-400 mt-1 text-left">כרגע</p>
              </div>
            </div>
            ...
            <div className="bg-[#f0f0f0] p-3 flex items-center gap-2">
              ...
              <button
                onClick={handleSend}
                className="w-9 h-9 bg-green-600 hover:bg-green-700 rounded-full flex items-center justify-center text-white transition-colors shrink-0"
              >
